...
use App\Filament\Widgets\GithubLinkWidget;
    ...
    */
    ...
    'policies' => [
        ...
        'methods' => [
            ...
            'forceDelete', 'forceDeleteAny', 'reorder', 'replicate',
            'restore', 'restoreAny',
        ],
    ...
    */
    ...
    'resources' => [
        ...
        'manage' => [
            ...
            VisitResource::class => [
                'delete_any', 'edit_any',
                'view_department', 'view_own', 'edit_department', 'edit_own',
                'delete_department', 'delete_own',
            ],
            VisitorResource::class => [
                'delete_any', 'edit_any',
                'check_in', 'check_out', 'print',
            ],
            UserResource::class => [
                'delete_any', 'view_own', 'edit_own',
                'view_department', 'edit_department', 'delete_department',
                'deactivate_any', 'deactivate_department', 'edit_any',
            ],
