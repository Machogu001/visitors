<div>
    ...
    >
        ...
        <button type="button" data-pwa-install class="btn btn-primary btn-xs rounded-lg">
            {{ __('Install') }}
        </button>
        <button type="button" data-pwa-dismiss-install class="btn btn-ghost btn-xs btn-square" aria-label="{{ __('Dismiss') }}">
            &times;
        </button>
    </div>
    ...
    >
        ...
        <button type="button" data-pwa-dismiss-ios class="btn btn-ghost btn-xs">{{ __('Dismiss') }}</button>
    </div>
</div>
